      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        ...
        >
          ...
          <p className="mb-4">
            ...
            Institute wrapped up in June 2025. I&apos;m actively looking for full-time
            opportunities in full-stack development — especially roles involving .NET and Angular
            enterprise systems.
          </p>
